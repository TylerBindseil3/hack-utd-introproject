...
function Card(props) {
  return (
    <div className = "p-4">
        <div className = "relative h-full w-fit rounded-2xl border-2 border-transparent bg-gradient-to-br from-orange to-pastelblue p-1 shadow-lg transition duration-300 hover:shadow-2xl">
